...
export default function HomePage() {
  return (
    <section
      ...
      className="relative isolate -mx-4 overflow-hidden sm:-mx-6 lg:-mx-8"
    >
      ...
      <div className="grid min-h-[calc(100vh-8rem)] items-center gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[0.86fr_1.14fr] lg:px-8">
        <div className="max-w-2xl">
          ...
          <h1
            id="hero-title"
            className="text-5xl font-black leading-[0.9] tracking-normal text-white sm:text-7xl"
          >
            Alcide prepare
            <span className="block text-primary-300">vos entrainements.</span>
          </h1>

          <p className="mt-6 max-w-xl rounded-xl bg-zinc-950/85 px-4 py-3 text-base leading-7 text-zinc-100 shadow-xl shadow-black/20 sm:text-lg">
            Selectionnez votre sport, indiquez vos objectifs et vos contraintes, puis laissez l
            application construire une seance ou un programme complet, pret a suivre avec timer et
            historique.
          </p>
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <h2 className="text-3xl font-black text-white">
                  Une app pour passer de l idee a la seance.
                </h2>
                <p className="muted-copy mt-2 max-w-xl">
                  Alcide transforme un besoin simple en plan exploitable : echauffement, blocs d
                  exercices, durees, repos et intensite adaptee au niveau.
                </p>
              </div>
          ...
          <GlassPanel className="p-5 sm:p-6">
            ...
            <div className="mt-6 space-y-3">
              {['Objectif', 'Structure', 'Timer'].map((label, index) => (
                <div
                  key={label}
                  className="flex items-center gap-3 rounded-full bg-zinc-950/[0.42] p-2"
                >
        ...
        <div className="grid min-h-[70vh] items-center gap-6 rounded-[2rem] border border-white/15 bg-[#14200f]/45 p-5 shadow-2xl shadow-black/25 backdrop-blur-xl sm:p-8 lg:grid-cols-[0.78fr_1.22fr]">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-zinc-200">
              La page d accueil presente maintenant l application avant de pousser vers la creation
              : ce que fait Alcide, comment l utiliser, et pourquoi revenir suivre sa progression.
            </p>
          </div>
