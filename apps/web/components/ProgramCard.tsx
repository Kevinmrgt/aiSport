      ...
      >
        ...
        <div className="mt-5 grid grid-cols-2 gap-2 sm:grid-cols-4">
          <div className="rounded-full bg-zinc-950/[0.46] px-3 py-2">
            <p className="text-[0.65rem] font-bold uppercase tracking-[0.14em] text-zinc-300">Cycle</p>
            <p className="text-sm font-black text-white">{program.weeksCount} sem.</p>
          </div>
          <div className="rounded-full bg-zinc-950/[0.46] px-3 py-2">
            <p className="text-[0.65rem] font-bold uppercase tracking-[0.14em] text-zinc-300">Rythme</p>
            <p className="text-sm font-black text-white">{program.sessionsPerWeek}/sem.</p>
          </div>
          <div className="rounded-full bg-zinc-950/[0.46] px-3 py-2">
            <p className="text-[0.65rem] font-bold uppercase tracking-[0.14em] text-zinc-300">Seance</p>
