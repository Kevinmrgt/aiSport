...
| B2-A14 | C2.4.1                            | Manuel utilisateur                                                                                            | Présent dans le gel `v0.13.0-rc.2`                                                                    | `docs/rncp/bloc2-manuel-utilisateur-alcide.md`                                                     |
| B2-A15 | C2.4.1                            | Manuel de mise à jour                                                                                         | Présent dans le gel `v0.13.0-rc.2`                                                                    | `docs/rncp/bloc2-manuel-mise-a-jour.md`                                                            |
