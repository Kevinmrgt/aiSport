    ...
    story.extend(
        section(
            ...
            [
                ...
                p("Démonstration sans panne de production", "h2"),
                bullet("Dans Actions, lancer Monitoring - Production health avec check_mode = simulate_alert."),
                bullet("Capturer le job rouge, l'artefact et l'issue [TEST] Production healthcheck alert simulation avec le label monitoring-test."),
                bullet("Relancer avec check_mode = simulate_recovery et capturer la fermeture de cette issue test."),
                bullet("Présenter la simulation comme telle. Elle vérifie le circuit GitHub sans provoquer d'indisponibilité ni modifier l'application de production."),
                callout(
    ...
    story.extend(
        section(
            ...
            [
                ...
                bullet("Démonstration simulate_alert puis simulate_recovery, clairement identifiée comme test sûr et non comme panne réelle."),
