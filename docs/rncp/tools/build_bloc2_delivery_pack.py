    ...
    return (
        "\n".join(
            [
                ...
                "- B2-A42 - accès jury sécurisé et quota de 30 générations",
                "- B2-A43 - interface métier sans prix ni détails techniques, CI/CD rc.8 et recette navigateur de production",
                "",
