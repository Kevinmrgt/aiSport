...
> **Archive historique — ne pas utiliser comme état courant.** Cette preuve
> fige la situation du 2026-05-07 en `0.12.0` avec 70 tests API. La source de
> vérité actuelle est le
> [tableau de pilotage du 2026-09-07](./bloc3-annexes/B3-A02-tableau-pilotage-2026-09-07.md) :
> `0.13.0-rc.8`, 261/261 tests unitaires, audits à zéro et smoke E2E 54/54.
...
## 5. Décision de pilotage historique
