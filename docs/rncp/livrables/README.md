...
reste la source de vérité : la recette authentifiée B2-A25 et la suite
Playwright OAuth B2-A26 y sont distinguées de l'audit humain RGAA, qui n'est
pas déclaré validé. Le PDF `0.13.0-rc.3` précède B2-A26 et doit être régénéré
avant remise si cette nouvelle preuve doit apparaître dans le livrable PDF.
