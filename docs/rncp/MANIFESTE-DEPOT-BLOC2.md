...
| --: | ------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------- |
|  01 | Dossier écrit | `output/pdf/dossier-bloc2-rncp39583-alcide-v0.13.0-rc.6-final-2026-07-23.pdf` | limite de 30 pages, signets, liens et rendu contrôlés             |
|  02 | Annexes       | `output/pdf/annexes-bloc2-rncp39583-alcide-v0.13.0-rc.6-final-2026-07-23.pdf` | preuves sélectionnées, quatre livrables complets et trois manuels |
...
- lint, contrôle de types, 256 tests et builds réussis sur la version `rc.6` ;
...
- accès jury contre-recetté en production : refus générique, connexion,
  pages privées, déconnexion et nouvelle protection des routes ;
