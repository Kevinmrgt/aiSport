...
- [x] version de production `0.13.0-rc.8` disponible ;
- [x] commit `f817073de7ed7220fbbc38d396f1d181811012bd` validé par la CI
      `29999207578` et la CD `29999526386` ;
- [x] API liveness/readiness et Web en HTTP 200 ;
- [x] audit de dépendances au seuil `low` sans vulnérabilité connue ;
- [x] lint, contrôle de types, 261 tests, intégration PostgreSQL concurrente et builds réussis ;
...
- [x] modèle, fournisseur, prix estimé, coût et métriques de sortie absents du
      formulaire de séance et de la page Coach en production ;
