...
| Élément                            | Valeur                                                                                                                        |
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Scénarios de recette comptabilisés | 62 ; CR-049 est un risque architectural suivi séparément et n'entre pas dans le dénominateur                                  |
...
| ----------------------------------- | ----------------------------- | --------------------------------- | -------------------------------------------------------- |
| Authentification et session         | CR-001 à CR-007 (7)           | 7 renseignés                      | B2-A25, B2-A30, accès jury rc.6, E2E OAuth `29833210488` |
...
| **Total**                           | **62**                        | **62 résultats documentés**       | **index des annexes et présent cahier**                  |
...
| CR-005 | Connexion jury valide     | accès actif, saisir les identifiants temporaires                        | vraie session Auth.js dédiée puis redirection `/generate`        | tests unitaires + Playwright + recette production | Automatisé localement ; recette production à consigner dans B2-A42                                                        |
...
Les 62 scénarios de recette sont reliés à une preuve ou à une réserve explicite.
