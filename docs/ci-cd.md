...
- Les previews automatiques du projet Vercel `ai-sport-api` sont desactivees tant que le provisioning Neon preview n'est pas assaini ; la CI GitHub et la production API restent les controles bloquants.
